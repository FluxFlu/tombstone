...
const { add, subtract, mult, divide, modulo, exponent, not, bit_and, bit_not, bit_or, bit_xor, right_shift, right_shift_unsigned, left_shift, softEquals, flessThan, fgreaterThan, fgreaterThanOrEqualTo, flessThanOrEqualTo, hardEquals, notEquals, hardNotEquals, and, or,  } = require("./language-specifics/wasm/stdMath");
const { fplusplus, fminusminus, plusEquals, minusEquals, multEquals, divEquals, modEquals, exponentEquals, leftShiftEquals, rightShiftEquals, unsignedRightShiftEquals, bitAndEquals, bitOrEquals, bitXorEquals, andEquals, orEquals, } = require("./language-specifics/wasm/impureMath");
